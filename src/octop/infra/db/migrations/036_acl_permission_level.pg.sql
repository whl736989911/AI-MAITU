...
--
-- SQLite boots apply the same DDL through
-- migrate.py::_ensure_feature_overlay_schema; this file runs here directly and
...
--
-- SQLite boots apply the same DDL through
-- migrate.py::_ensure_feature_run_schema; this file runs here directly and
-- ``IF NOT EXISTS`` keeps it idempotent.
...
--
-- SQLite boots apply the same DDL through
-- migrate.py::_ensure_feature_change_schema; this file runs here directly and
-- ``IF NOT EXISTS`` keeps it idempotent.
