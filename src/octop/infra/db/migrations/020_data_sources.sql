...
-- sources with it.
--
-- SQLite boots apply this through migrate.py::_ensure_data_sources_schema:
-- databases whose watermark skipped 20 — a clamp, or a build that stamped the
-- version without the DDL — still get the table the control plane writes to.
